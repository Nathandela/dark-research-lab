...
External articles that directly influenced dark-research-lab's architecture.
...
```bash
drl knowledge "relevant query"  # Search docs knowledge base
drl search "relevant query"     # Search lessons memory
```
