...
## Instructions
1. Read `docs/drl/research/security/secrets-checklist.md` for key format patterns and detection heuristics
...
## Literature
- Consult `docs/drl/research/security/secrets-checklist.md` for format patterns and hiding spots
- Consult `docs/drl/research/security/secure-coding-failure.md` section 4.6 for theoretical foundation
- Run `drl knowledge "secrets credentials hardcoded"` for indexed knowledge
