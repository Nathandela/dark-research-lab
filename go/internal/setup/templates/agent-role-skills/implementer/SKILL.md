...
- Run `drl knowledge "TDD implementation"` for indexed knowledge on implementation patterns

## Memory Integration
Run `drl search` with the task description for known patterns, solutions, and implementation approaches relevant to the feature area.
