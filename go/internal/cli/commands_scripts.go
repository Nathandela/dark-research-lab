...
func loopScriptPromptBuilder(bt string) string { //nolint:funlen // bash template string
	...
	fmt.Fprintf(&b, "Run the full cook-it workflow for this epic, starting from the plan phase\n")
	fmt.Fprintf(&b, "(spec-dev is already done -- the epic exists):\n\n")
	fmt.Fprintf(&b, "/drl:cook-it from plan -- Epic: $epic_id\n\n")
	fmt.Fprintf(&b, "Work through all phases: plan, work, review, synthesis.\n\n")
