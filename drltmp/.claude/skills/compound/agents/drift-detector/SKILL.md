...
## Instructions
1. Run `drl audit --json` for automated constraint checking
...
5. Use `drl search` for past architectural decisions that may apply
...
- Run `drl knowledge "invariant drift detection"` for indexed knowledge on drift patterns
