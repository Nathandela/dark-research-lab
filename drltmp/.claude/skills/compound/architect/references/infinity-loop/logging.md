...
|------|---------|---------|
| `$TRACEFILE` | `trace_*.jsonl` | Raw stream-json for `drl watch` and forensic analysis |
...
This allows `drl watch` to find the active session without knowing the filename.
