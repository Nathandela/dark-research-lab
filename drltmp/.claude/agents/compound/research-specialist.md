...
1. **Gather context**: Run `drl search "<topic>"` and `drl knowledge "<topic>"` to check existing knowledge. Scan `docs/research/` and `docs/compound/research/` for prior work.
